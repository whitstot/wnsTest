			...
			<div>
                <div ref={(eref) => {this.refs['paragraph'] = findDOMNode(eref)}} className="rainbow">
                    ...
                    <div className="webParagraph2wrap">
	                    <div className={this.state.webParagraph2Class}>I am a former Front-End Web Developer for The Chickasaw Nation. If you're wanting your website created, contact me under the contact tab!
	                    </div>
	                </div>
                </div>
			</div>
